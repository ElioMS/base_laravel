...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('vendor/ems/dropzone/dropzone-ems.css') }}">
</head>
<body>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-primary aqua" {{-- id="upload-btn" --}}>{{ trans('laravel-filemanager::lfm.btn-upload') }}</button>
        </div>
      </div>
    </div>
  </div>
  ...
  <script src="{{ asset('vendor/ems/dropzone/dropzone.js') }}"></script>
  <script>
